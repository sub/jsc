jsc, a clear and REST Ruby API to {Google Closure Compiler web service}[http://code.google.com/closure/compiler/]
    by sub
    http://github.com/sub/jsc

== DESCRIPTION:

A clear and REST Ruby API to Google Closure Compiler web service.
...
=======
jsc require the {bones}[http://gemcutter.org/gems/bones] gem
>>>>>>> 6faa0b01909a775ab769c176fa5ef032d1f08c09:README.rdoc
